import numba as nb
import numpy as np
from numba_mwu import MannWhitneyUResult, mannwhitneyu_columns, mannwhitneyu_sparse
...
def mwu(x: np.ndarray | csr_matrix, y: np.ndarray | csr_matrix) -> MannWhitneyUResult:
